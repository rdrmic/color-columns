...
pub const HOWTOPLAY_AND_CREDITS_CHAR_SCALE: f32 = 22.0;
pub const TEXT_POSITION_X: f32 = 50.0;
pub const HOWTOPLAY_CONTROLS_TEXT_POSITION: (f32, f32) = (TEXT_POSITION_X, 140.0);
pub const HOWTOPLAY_SCORING_RULES_TEXT_POSITION: (f32, f32) = (TEXT_POSITION_X, 310.0);
pub const CREDITS_TEXT_POSITION: (f32, f32) = (TEXT_POSITION_X, 190.0);
