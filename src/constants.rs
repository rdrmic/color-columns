...
pub const ABOUT_TEXT_POSITION: (f32, f32) = (HOWTOPLAY_AND_ABOUT_TEXT_POSITION_X, 170.0);
pub const ABOUT_VERSION_CHAR_SCALE: f32 = 19.0;
pub const ABOUT_VERSION_POSITION: (f32, f32) = (HOWTOPLAY_AND_ABOUT_TEXT_POSITION_X, 475.0);
